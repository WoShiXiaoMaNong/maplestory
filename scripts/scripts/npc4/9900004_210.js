...
cm.serverNotice("萌新公告：玩家“"+ cm.getChar().getName() +"”成为了萌新vip!");
cm.serverNotice("萌新公告：玩家“"+ cm.getChar().getName() +"”成为了萌新vip!");
					//cm.getC().getChannelServer().getWorldInterface().broadcastMessage(null, net.sf.cherry.Packages.tools.MaplePacketCreator.serverNotice(2,cm.getC().getChannel(),"123萌新管理员" + " : 恭喜：" + cm.getPlayer().getName() +" 玩家成为萌新vIp!!!",true).getBytes());
					//cm.getC().getChannelServer().getWorldInterface().broadcastMessage(null, net.sf.cherry.Packages.tools.MaplePacketCreator.serverNotice(2,cm.getC().getChannel(),"321萌新管理员" + " : 恭喜：" + cm.getPlayer().getName() +" 玩家成为萌新vIp!!!",true).getBytes());
					//cm.getC().getChannelServer().getWorldInterface().broadcastMessage(null, net.sf.cherry.Packages.tools.MaplePacketCreator.serverNotice(2,cm.getC().getChannel(),"321萌新管理员" + " : 恭喜：" + cm.getPlayer().getName() +" 玩家成为萌新vIp!!!",true).getBytes());
                       cm.dispose(); 
}
                    } else { 
...
//---------------------------------------------------
		        cm.getChar().saveToDB(true);
cm.getC().getChannelServer().getWorldInterface().broadcastMessage(null, net.sf.cherry.Packages.tools.MaplePacketCreator.serverNotice(11,cm.getC().getChannel(),"萌新管理员" + " : 恭喜:" + cm.getPlayer().getName() +" 玩家成为萌新vIp③!!!",true).getBytes());
							cm.getC().getChannelServer().getWorldInterface().broadcastMessage(null, net.sf.cherry.Packages.tools.MaplePacketCreator.serverNotice(11,cm.getC().getChannel(),"萌新管理员" + " : 恭喜:" + cm.getPlayer().getName() +" 玩家成为萌新vIp③!!!",true).getBytes());
							cm.getC().getChannelServer().getWorldInterface().broadcastMessage(null, net.sf.cherry.Packages.tools.MaplePacketCreator.serverNotice(11,cm.getC().getChannel(),"萌新管理员" + " : 恭喜:" + cm.getPlayer().getName() +" 玩家成为萌新vIp③!!!",true).getBytes());
...
//---------------------------------------------------
		        cm.getChar().saveToDB(true);
                       ...
                       cm.sendOk("成功成为#r萌新vIp④#k!"); 
 cm.getC().getChannelServer().getWorldInterface().broadcastMessage(null, net.sf.cherry.Packages.tools.MaplePacketCreator.serverNotice(12,cm.getC().getChannel(),"萌新管理员" + " : 恭喜:" + cm.getPlayer().getName() +" 玩家成为萌新vIp④!!!",true).getBytes());
							cm.getC().getChannelServer().getWorldInterface().broadcastMessage(null, net.sf.cherry.Packages.tools.MaplePacketCreator.serverNotice(12,cm.getC().getChannel(),"萌新管理员" + " : 恭喜:" + cm.getPlayer().getName() +" 玩家成为萌新vIp④!!!",true).getBytes());
							cm.getC().getChannelServer().getWorldInterface().broadcastMessage(null, net.sf.cherry.Packages.tools.MaplePacketCreator.serverNotice(12,cm.getC().getChannel(),"萌新管理员" + " : 恭喜:" + cm.getPlayer().getName() +" 玩家成为萌新vIp④!!!",true).getBytes());	
                       cm.dispose();  } 
                    } else { 
...
//---------------------------------------------------
 ...
 cm.getC().getChannelServer().getWorldInterface().broadcastMessage(null, net.sf.cherry.Packages.tools.MaplePacketCreator.serverNotice(12,cm.getC().getChannel(),"萌新管理员" + " : 恭喜:" + cm.getPlayer().getName() +" 玩家成为萌新vIp⑤の战斗之神!!!",true).getBytes());
							cm.getC().getChannelServer().getWorldInterface().broadcastMessage(null, net.sf.cherry.Packages.tools.MaplePacketCreator.serverNotice(12,cm.getC().getChannel(),"萌新管理员" + " : 恭喜:" + cm.getPlayer().getName() +" 玩家成为萌新vIp⑤の战斗之神!!!",true).getBytes());
							cm.getC().getChannelServer().getWorldInterface().broadcastMessage(null, net.sf.cherry.Packages.tools.MaplePacketCreator.serverNotice(12,cm.getC().getChannel(),"萌新管理员" + " : 恭喜:" + cm.getPlayer().getName() +" 玩家成为七里vIp⑤の战斗之神!!!",true).getBytes());	
...
//---------------------------------------------------
 ...
 cm.getC().getChannelServer().getWorldInterface().broadcastMessage(null, net.sf.cherry.Packages.tools.MaplePacketCreator.serverNotice(12,cm.getC().getChannel(),"萌新管理员" + " : 恭喜:" + cm.getPlayer().getName() +" 玩家成功升级成为萌新vIp④!!!",true).getBytes());
							cm.getC().getChannelServer().getWorldInterface().broadcastMessage(null, net.sf.cherry.Packages.tools.MaplePacketCreator.serverNotice(12,cm.getC().getChannel(),"萌新管理员" + " : 恭喜:" + cm.getPlayer().getName() +" 玩家成功升级成为萌新vIp④!!!",true).getBytes());
							cm.getC().getChannelServer().getWorldInterface().broadcastMessage(null, net.sf.cherry.Packages.tools.MaplePacketCreator.serverNotice(12,cm.getC().getChannel(),"萌新管理员" + " : 恭喜:" + cm.getPlayer().getName() +" 玩家成功升级成为萌新vIp④!!!",true).getBytes());	
                       cm.dispose(); 
                    } else { 
...
//---------------------------------------------------
 ...
 cm.getC().getChannelServer().getWorldInterface().broadcastMessage(null, net.sf.cherry.Packages.tools.MaplePacketCreator.serverNotice(12,cm.getC().getChannel(),"萌新管理员" + " : 恭喜:" + cm.getPlayer().getName() +" 玩家成功升级成为萌新vIp⑤!!!",true).getBytes());
							cm.getC().getChannelServer().getWorldInterface().broadcastMessage(null, net.sf.cherry.Packages.tools.MaplePacketCreator.serverNotice(12,cm.getC().getChannel(),"萌新管理员" + " : 恭喜:" + cm.getPlayer().getName() +" 玩家成功升级成为萌新vIp⑤!!!",true).getBytes());
							cm.getC().getChannelServer().getWorldInterface().broadcastMessage(null, net.sf.cherry.Packages.tools.MaplePacketCreator.serverNotice(12,cm.getC().getChannel(),"萌新管理员" + " : 恭喜:" + cm.getPlayer().getName() +" 玩家成功升级成为七里香vIp⑤!!!",true).getBytes());	 
                       cm.dispose(); 
                    } else { 
                       cm.sendOk("你没有足够的充值币，请充值！"); 
                       cm.dispose();   
...
//---------------------------------------------------
 ...
 cm.getC().getChannelServer().getWorldInterface().broadcastMessage(null, net.sf.cherry.Packages.tools.MaplePacketCreator.serverNotice(12,cm.getC().getChannel(),"萌新管理员" + " : 恭喜:" + cm.getPlayer().getName() +" 玩家成功升级成为萌新vIp⑤の战斗之神!!!",true).getBytes());
							cm.getC().getChannelServer().getWorldInterface().broadcastMessage(null, net.sf.cherry.Packages.tools.MaplePacketCreator.serverNotice(12,cm.getC().getChannel(),"萌新管理员" + " : 恭喜:" + cm.getPlayer().getName() +" 玩家成功升级成为萌新vIp⑤の战斗之神!!!",true).getBytes());
							cm.getC().getChannelServer().getWorldInterface().broadcastMessage(null, net.sf.cherry.Packages.tools.MaplePacketCreator.serverNotice(12,cm.getC().getChannel(),"萌新管理员" + " : 恭喜:" + cm.getPlayer().getName() +" 玩家成功升级成为萌新vIp⑤の战斗之神!!!",true).getBytes());	
cm.viplaba("恭喜:" + cm.getPlayer().getName() +"加入萌新顶级会员.",5121006); 
                       cm.dispose(); 
...
net.sf.cherry.server.MapleInventoryManipulator.addFromDrop(cm.getC(), toDrop, -1);
		        cm.getChar().saveToDB(true);
cm.getC().getChannelServer().getWorldInterface().broadcastMessage(null, net.sf.cherry.Packages.tools.MaplePacketCreator.serverNotice(11,cm.getC().getChannel(),"系统管理员" + " : " + "恭喜 " + cm.getPlayer().getName() +" 玩家从VIP2成功升级到VIP3",true).getBytes());
							cm.getC().getChannelServer().getWorldInterface().broadcastMessage(null, net.sf.cherry.Packages.tools.MaplePacketCreator.serverNotice(12,cm.getC().getChannel(),"系统管理员" + " : " + "恭喜 " + cm.getPlayer().getName() +" 玩家从VIP2成功升级到VIP3",true).getBytes());
							cm.getC().getChannelServer().getWorldInterface().broadcastMessage(null, net.sf.cherry.Packages.tools.MaplePacketCreator.serverNotice(11,cm.getC().getChannel(),"系统管理员" + " : " + "恭喜 " + cm.getPlayer().getName() +" 玩家从VIP2成功升级到VIP3",true).getBytes());
                       cm.sendOk("升级成功！祝您游戏愉快！ 你现在剩有充值币 #r"+cm.getmoneyb()+"#k"); 
                       cm.dispose(); }
                    } else { 
...
net.sf.cherry.server.MapleInventoryManipulator.addFromDrop(cm.getC(), toDrop, -1);
		        cm.getChar().saveToDB(true);
                       cm.sendOk("升级成功！祝您游戏愉快！ 你现在剩有充值币 #r"+cm.getmoneyb()+"#k"); 
cm.getC().getChannelServer().getWorldInterface().broadcastMessage(null, net.sf.cherry.Packages.tools.MaplePacketCreator.serverNotice(12,cm.getC().getChannel(),"系统管理员" + " : " + "恭喜 " + cm.getPlayer().getName() +" 玩家从VIP3成功升级到VIP4",true).getBytes());
							cm.getC().getChannelServer().getWorldInterface().broadcastMessage(null, net.sf.cherry.Packages.tools.MaplePacketCreator.serverNotice(11,cm.getC().getChannel(),"系统管理员" + " : " + "恭喜 " + cm.getPlayer().getName() +" 玩家从VIP3成功升级到VIP4",true).getBytes());
							cm.getC().getChannelServer().getWorldInterface().broadcastMessage(null, net.sf.cherry.Packages.tools.MaplePacketCreator.serverNotice(12,cm.getC().getChannel(),"系统管理员" + " : " + "恭喜 " + cm.getPlayer().getName() +" 玩家从VIP3成功升级到VIP4",true).getBytes());
                       cm.dispose(); }
                    } else { 
                       cm.sendOk("你没有足够的充值币，请充值！"); 
