           ...
           // text += ""+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+"\r\n"
			...
			if(cm.haveItem(4031551,1)){ //物品条件
               ...
               //cm.喇叭(2, "【组队任务 - 海盗副本】[" + cm.getPlayer().getName() + "]召唤出一只 大金鱼，你们自求多福吧！！");
			   			Packages.handling.world.World.Broadcast.broadcastMessage(Packages.Packages.tools.MaplePacketCreator.serverNotice(11, cm.getClient().getChannel(), "『组队任务 - 海盗副本』" + " : " + "[" + cm.getChar().getName() + "]召唤出一只[大金鱼]，你们自求多福吧！！"));
			   cm.dispose();
		   }else{
...
//cm.喇叭(2, "[" + cm.getPlayer().getName() + "]成功击败【大金鱼】，通关海盗副本，获得奖励！！");
			   			Packages.handling.world.World.Broadcast.broadcastMessage(Packages.Packages.tools.MaplePacketCreator.serverNotice(12, cm.getClient().getChannel(), "『组队任务 - 海盗副本』" + " : " + "[" + cm.getChar().getName() + "]成功击败【大金鱼】，通关海盗副本，获得奖励！！"));
			   cm.dispose();
		   }else{
