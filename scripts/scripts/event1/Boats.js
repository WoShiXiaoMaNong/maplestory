...
function scheduleNew() {
	...
	Orbis_Station.broadcastMessage(Packages.tools.MaplePacketCreator.boatPacket(true));
	Boat_to_Orbis.setDocked(false);
	Boat_to_Ellinia.setDocked(false);
	em.setProperty("docked", "true");
	em.setProperty("entry", "true");
...
function takeoff() {
	...
	Orbis_Station.broadcastMessage(Packages.tools.MaplePacketCreator.boatPacket(false));
...
function invasion() {
	...
	if(numspawn > 0) {
		...
		Boat_to_Orbis.broadcastMessage(Packages.tools.MaplePacketCreator.boatPacket(true));
		Boat_to_Ellinia.broadcastMessage(Packages.tools.MaplePacketCreator.boatPacket(true));
		Boat_to_Orbis.broadcastMessage(Packages.tools.MaplePacketCreator.musicChange("Bgm04/ArabPirate"));
		Boat_to_Ellinia.broadcastMessage(Packages.tools.MaplePacketCreator.musicChange("Bgm04/ArabPirate"));
