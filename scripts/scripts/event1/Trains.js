...
function scheduleNew() {
	...
	Orbis_Station.setDocked(true);
	Ludibrium_Station.broadcastMessage(Packages.tools.MaplePacketCreator.boatPacket(true));
...
function takeoff() {
	...
	Orbis_Station.setDocked(false);
	Ludibrium_Station.broadcastMessage(Packages.tools.MaplePacketCreator.boatPacket(false));
