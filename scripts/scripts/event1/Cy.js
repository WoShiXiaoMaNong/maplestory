...
function scheduleNew() {
	...
	if(toggleMsg) {
		KC_docked.broadcastMessage(Packages.tools.MaplePacketCreator.serverNotice(6, "地铁列车2号线:开往废弃都市的列车已经到达。"));
		NLC_docked.broadcastMessage(Packages.tools.MaplePacketCreator.serverNotice(6, "地铁列车1号线:开往新叶城的列车已经到达。"));
	}
...
function takeoff() {
	...
	if(toggleMsg) {
		KC_docked.broadcastMessage(Packages.tools.MaplePacketCreator.serverNotice(6, "地铁列车1号线:开往新叶城的列车已经发出，来不及乘坐的岛民请等候下个班次。"));
		NLC_docked.broadcastMessage(Packages.tools.MaplePacketCreator.serverNotice(6, "地铁列车2号线:开往废弃都市的列车已经发出，来不及乘坐的岛民请等候下个班次。"));
	}
