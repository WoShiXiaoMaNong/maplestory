...
function enter(pi) {
	...
	if (playerStatus) {
		...
		pi.getPlayer().getClient().getSession().write(Packages.tools.MaplePacketCreator.serverNotice(5, "Only the party leader has the desision whether to leave this room or not."));
		return false;
	}
}
