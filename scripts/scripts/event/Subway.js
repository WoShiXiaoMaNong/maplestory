...
function scheduleNew() {
	...
	if(toggleMsg) {
		KC_docked.broadcastMessage(Packages.tools.MaplePacketCreator.serverNotice(5, "[地铁] 列车已经到站，请需要离开的速度上车！"));
		NLC_docked.broadcastMessage(Packages.tools.MaplePacketCreator.serverNotice(5, "[地铁] 列车已经到站，请需要离开的速度上车！"));
	}
...
function takeoff() {
	...
	if(toggleMsg) {
		KC_docked.broadcastMessage(Packages.tools.MaplePacketCreator.serverNotice(5, "[地铁] 列车已经出发，未上车的旅客请等待下次列车！"));
		NLC_docked.broadcastMessage(Packages.tools.MaplePacketCreator.serverNotice(5, "[地铁] 列车已经出发，未上车的旅客请等待下次列车！"));
	}
