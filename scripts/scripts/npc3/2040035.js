...
//		toDrop.setUpgradeSlots(cishu);				
		...
		cm.getC().getChannelServer().getWorldInterface().broadcastMessage(null,Packages.tools.MaplePacketCreator.getItemMegas(cm.getC().getChannel(),cm.getPlayer().getName() + " : " + "从玩具城任务中获得！大家一起恭喜他（她）吧！！！",toDrop, true).getBytes());	
