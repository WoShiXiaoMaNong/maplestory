...
function action(mode, type, selection) {
 ...
 cm.getC().getChannelServer().getWorldInterface().broadcastMessage(null, Packages.tools.MaplePacketCreator.serverNotice(12,cm.getC().getChannel(),"[颁奖]" + " : " + " [" + cm.getPlayer().getName() + "]玩家获得了道具奖励！",true).getBytes());
				}
				...
				//cm.gainItem(5220001,-1);
				cm.setboss(1);
     				cm.getC().getChannelServer().getWorldInterface().broadcastMessage(null, Packages.tools.MaplePacketCreator.serverNotice(12,cm.getC().getChannel(),"[颁奖]" + " : " + " [" + cm.getPlayer().getName() + "]玩家获得了诅咒卷奖励！",true).getBytes());
				cm.warp(100000000);
				cm.dispose();
			}
		} else if (status == 3) {
