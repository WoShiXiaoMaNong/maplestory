    ...
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            if (cm.getPlayer().getInventory(net.sf.odinms.client.MapleInventoryType.getByType(1)).isFull()) {
                ...
                cm.setshouc(+1);
                cm.sendOk("恭喜您领取成功。");
                cm.getC().getChannelServer().getWorldInterface().broadcastMessage(null, net.sf.chrry.Packages.tools.MaplePacketCreator.serverNotice(12, cm.getC().getChannel(), "[赞助奖励]" + " : " + " [" + cm.getPlayer().getName() + "]玩家领取了 赞助 - 100元礼包.", true).getBytes());
                cm.dispose();
            } else {
            ...
            if (cm.getPlayer().getInventory(net.sf.odinms.client.MapleInventoryType.getByType(1)).isFull()) {
                ...
                cm.setshouc(+1);
                cm.sendOk("恭喜您领取成功。");
                cm.getC().getChannelServer().getWorldInterface().broadcastMessage(null, net.sf.chrry.Packages.tools.MaplePacketCreator.serverNotice(12, cm.getC().getChannel(), "[赞助奖励]" + " : " + " [" + cm.getPlayer().getName() + "]玩家领取了 赞助 - 300元礼包.", true).getBytes());
                cm.dispose();
            } else {
            ...
            if (cm.getPlayer().getInventory(net.sf.odinms.client.MapleInventoryType.getByType(1)).isFull()) {
                ...
                cm.setshouc(+1);
                cm.sendOk("恭喜您领取成功。");
                cm.getC().getChannelServer().getWorldInterface().broadcastMessage(null, net.sf.chrry.Packages.tools.MaplePacketCreator.serverNotice(12, cm.getC().getChannel(), "[赞助奖励]" + " : " + " [" + cm.getPlayer().getName() + "]玩家领取了 赞助 - 500元礼包.", true).getBytes());
                cm.dispose();
            } else {
            ...
            if (cm.getPlayer().getInventory(net.sf.odinms.client.MapleInventoryType.getByType(1)).isFull()) {
                ...
                cm.setshouc(+1);
                cm.sendOk("恭喜您领取成功。");
                cm.getC().getChannelServer().getWorldInterface().broadcastMessage(null, net.sf.chrry.Packages.tools.MaplePacketCreator.serverNotice(12, cm.getC().getChannel(), "[赞助奖励]" + " : " + " [" + cm.getPlayer().getName() + "]玩家领取了 赞助 - 1000元礼包.", true).getBytes());
                cm.dispose();
            } else {
            ...
            if (cm.getPlayer().getInventory(net.sf.odinms.client.MapleInventoryType.getByType(1)).isFull()) {
                ...
                cm.setshouc(+1);
                cm.sendOk("恭喜您领取成功。");
                cm.getC().getChannelServer().getWorldInterface().broadcastMessage(null, net.sf.chrry.Packages.tools.MaplePacketCreator.serverNotice(12, cm.getC().getChannel(), "[赞助奖励]" + " : " + " [" + cm.getPlayer().getName() + "]玩家领取了 赞助 - 2000元礼包.", true).getBytes());
                cm.dispose();
            } else {
