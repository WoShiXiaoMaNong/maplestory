...
if(cm.getChar().getReborns() <= 50){
				...
				cm.getC().getChannelServer().getWorldInterface().broadcastMessage(null, Packages.tools.MaplePacketCreator.serverNotice(12,cm.getC().getChannel(),"稀饭管理员" + " : " + "恭喜 [" + cm.getPlayer().getName() + "] 第 " + cm.getChar().getReborns() + " 次转生,吼吼 O(∩_∩)O.",true).getBytes());
 				cm.dispose();           
		}
  }
}
