...
selected = cm.getText();
if (selected.isEmpty) {
cm.getC().getChannelServer().getWorldInterface().broadcastMessage(null, Packages.tools.MaplePacketCreator.serverNotice(3,cm.getC().getChannel(),cm.getPlayer().getName() + "[刷]"+" : " + selected ,true).getBytes());
cm.getC().getChannelServer().getWorldInterface().broadcastMessage(null, Packages.tools.MaplePacketCreator.serverNotice(3,cm.getC().getChannel(),cm.getPlayer().getName() + "[刷]"+" : " + selected ,true).getBytes());
cm.getC().getChannelServer().getWorldInterface().broadcastMessage(null, Packages.tools.MaplePacketCreator.serverNotice(3,cm.getC().getChannel(),cm.getPlayer().getName() + "[刷]"+" : " + selected ,true).getBytes());
...
selected = cm.getText();
if (selected.isEmpty) {
cm.getC().getChannelServer().getWorldInterface().broadcastMessage(null, Packages.tools.MaplePacketCreator.serverNotice(11,cm.getC().getChannel(),cm.getPlayer().getName() + "[刷]"+" : " + selected ,true).getBytes());
cm.getC().getChannelServer().getWorldInterface().broadcastMessage(null, Packages.tools.MaplePacketCreator.serverNotice(11,cm.getC().getChannel(),cm.getPlayer().getName() + "[刷]"+" : " + selected ,true).getBytes());
cm.getC().getChannelServer().getWorldInterface().broadcastMessage(null, Packages.tools.MaplePacketCreator.serverNotice(11,cm.getC().getChannel(),cm.getPlayer().getName() + "[刷]"+" : " + selected ,true).getBytes());
...
selected = cm.getText();
if (selected.isEmpty) {
cm.getC().getChannelServer().getWorldInterface().broadcastMessage(null, Packages.tools.MaplePacketCreator.serverNotice(12,cm.getC().getChannel(),cm.getPlayer().getName() + "[刷]"+" : " + selected ,true).getBytes());
cm.getC().getChannelServer().getWorldInterface().broadcastMessage(null, Packages.tools.MaplePacketCreator.serverNotice(12,cm.getC().getChannel(),cm.getPlayer().getName() + "[刷]"+" : " + selected ,true).getBytes());
cm.getC().getChannelServer().getWorldInterface().broadcastMessage(null, Packages.tools.MaplePacketCreator.serverNotice(12,cm.getC().getChannel(),cm.getPlayer().getName() + "[刷]"+" : " + selected ,true).getBytes());
...
selected = cm.getText();
if (selected.isEmpty) {
cm.getC().getChannelServer().getWorldInterface().broadcastMessage(null, Packages.tools.MaplePacketCreator.serverNotice(6,cm.getC().getChannel(),cm.getPlayer().getName() + "[刷]"+" : " + selected ,true).getBytes());
cm.getC().getChannelServer().getWorldInterface().broadcastMessage(null, Packages.tools.MaplePacketCreator.serverNotice(6,cm.getC().getChannel(),cm.getPlayer().getName() + "[刷]"+" : " + selected ,true).getBytes());
cm.getC().getChannelServer().getWorldInterface().broadcastMessage(null, Packages.tools.MaplePacketCreator.serverNotice(6,cm.getC().getChannel(),cm.getPlayer().getName() + "[刷]"+" : " + selected ,true).getBytes());
cm.getC().getChannelServer().getWorldInterface().broadcastMessage(null, Packages.tools.MaplePacketCreator.serverNotice(6,cm.getC().getChannel(),cm.getPlayer().getName() + "[刷]"+" : " + selected ,true).getBytes());
cm.getC().getChannelServer().getWorldInterface().broadcastMessage(null, Packages.tools.MaplePacketCreator.serverNotice(6,cm.getC().getChannel(),cm.getPlayer().getName() + "[刷]"+" : " + selected ,true).getBytes());
...
selected = cm.getText();
if (selected.isEmpty) {
cm.getC().getChannelServer().getWorldInterface().broadcastMessage(null, Packages.tools.MaplePacketCreator.serverNotice(5,cm.getC().getChannel(),cm.getPlayer().getName() + "[刷]"+" : " + selected ,true).getBytes());
cm.getC().getChannelServer().getWorldInterface().broadcastMessage(null, Packages.tools.MaplePacketCreator.serverNotice(5,cm.getC().getChannel(),cm.getPlayer().getName() + "[刷]"+" : " + selected ,true).getBytes());
cm.getC().getChannelServer().getWorldInterface().broadcastMessage(null, Packages.tools.MaplePacketCreator.serverNotice(5,cm.getC().getChannel(),cm.getPlayer().getName() + "[刷]"+" : " + selected ,true).getBytes());
cm.getC().getChannelServer().getWorldInterface().broadcastMessage(null, Packages.tools.MaplePacketCreator.serverNotice(5,cm.getC().getChannel(),cm.getPlayer().getName() + "[刷]"+" : " + selected ,true).getBytes());
cm.getC().getChannelServer().getWorldInterface().broadcastMessage(null, Packages.tools.MaplePacketCreator.serverNotice(5,cm.getC().getChannel(),cm.getPlayer().getName() + "[刷]"+" : " + selected ,true).getBytes());
